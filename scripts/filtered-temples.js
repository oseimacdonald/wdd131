...
// Function to generate temple gallery
function generateTempleGallery(filteredTemples) {
...
document.addEventListener('DOMContentLoaded', () => {
    generateTempleGallery(temples); // Show all temples initially
    ...
    navLinks.addEventListener('click', (event) => {
        if (event.target.tagName === 'A') {
            ...
            generateTempleGallery(filteredTemples);
        }
    });
});
